...
import ListboxBasicReact from "../../../examples/react/ListboxBasic.tsx";
import ListboxBasicReactSrc from "../../../examples/react/ListboxBasic.tsx?raw";
import ListboxBasicVue from "../../../examples/vue/ListboxBasic.vue";
import ListboxBasicVueSrc from "../../../examples/vue/ListboxBasic.vue?raw";
...
<Tabs syncKey="framework">
  <TabItem label="React">
    <Example code={ListboxBasicReactSrc} lang="tsx">
      <ListboxBasicReact client:load />
    </Example>
  </TabItem>
  <TabItem label="Vue">
    <Example code={ListboxBasicVueSrc} lang="vue">
      <ListboxBasicVue client:load />
    </Example>
  </TabItem>
</Tabs>
