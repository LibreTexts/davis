...
export const card = tv({
  ...
  variants: {
    ...
    padding: {
      ...
      // `body` gets vertical padding so content isn't flush against header/footer borders.
      none: { root: '',           header: '',             headerContent: '',           body: '',     footer: ''                       },
      sm:   { root: 'px-4 py-3', header: '-mx-4 -mt-3', headerContent: 'px-4 py-3', body: 'py-3', footer: '-mx-4 -mb-3 px-4 py-3' },
      md:   { root: 'px-6 py-4', header: '-mx-6 -mt-4', headerContent: 'px-6 py-4', body: 'py-4', footer: '-mx-6 -mb-4 px-6 py-4' },
      lg:   { root: 'px-8 py-6', header: '-mx-8 -mt-6', headerContent: 'px-8 py-6', body: 'py-6', footer: '-mx-8 -mb-6 px-8 py-6' },
    },
    clickable: {
